...
export type GetOrganizationUsersQuery = { __typename?: 'Query', getOrganizationUsers: Array<{ __typename?: 'OrganizationUser', id?: string | null, user_id: number, organization_id: number, role?: string | null, status?: string | null, created_at?: any | null, updated_at?: any | null, user: { __typename?: 'User', id: string, name: string, email: string, current_organization_id?: number | null, isActive: boolean }, organizations: Array<{ __typename?: 'Organization', id: string, name: string, domain: string }>, currentOrganization?: { __typename?: 'Organization', id: string, name: string, domain: string } | null }> };
