...
// GraphQL query to get all users of the current organization
...
const UsersPage: React.FC = () => {
  ...
  // Fetch organization users via GraphQL
          ...
          <tbody>
            {data.getOrganizationUsers.map((user: any) => (
              <tr key={user.id} className="hover:bg-gray-50">
                ...
                <td className="text-left px-4 py-2 border-b capitalize">{user.role}</td>
                <td className="text-left px-4 py-2 border-b">{user.status}</td>
                <td className="text-left px-4 py-2 border-b">{user.invited_by}</td>
                <td className="text-left px-4 py-2 border-b">{user.created_at}</td>
                <td className="text-left px-4 py-2 border-b">{user.updated_at}</td>
              </tr>
            ))}
          </tbody>
        </table>
