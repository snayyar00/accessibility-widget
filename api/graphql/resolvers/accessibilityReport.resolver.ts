...
const resolvers = {
  Query: {
    ...
    fetchAccessibilityReportFromR2: combineResolvers(isAuthenticated, async (_: any, { url, created_at, updated_at }: any, { user }) => {
    ...
    fetchReportByR2Key: combineResolvers(isAuthenticated, async (_: any, { r2_key }: any, { user }) => {
  ...
  Mutation: {
    saveAccessibilityReport: combineResolvers(isAuthenticated, async (_: any, { report, url, allowed_sites_id, key, score }: any, { user }) => {
