...
const proofOfEffortResolvers = {
  Mutation: {
    sendProofOfEffortToolkit: combineResolvers(allowedOrganization, isAuthenticated, async (_: any, args: { input: { email: string; domain: string; zipFileBase64: string; reportDate?: string } }, context: GraphQLContext) => {
      try {
