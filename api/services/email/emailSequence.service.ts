import { getUsersRegisteredOnDate, getLatestRegisteredUser } from '../../repository/user.repository';
...
export class EmailSequenceService {
  ...
  static async sendWelcomeEmail(userEmail: string, userName: string, userId: number): Promise<boolean> {
    try {
      ...
      let logoUrl = 'https://www.webability.io/images/logo.png';
      let fallbackLogoUrl = 'https://cdn.jsdelivr.net/gh/webability-io/assets/logo.png';
      
      // Additional fallback for maximum compatibility
      let altFallbackUrl = 'https://via.placeholder.com/150x40/1565C0/FFFFFF?text=WebAbility';
