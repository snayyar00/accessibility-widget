...
export class TemplateAnalysisService {
   ...
   */
  private static generateTemplateRecommendation(type: string, code: string, pattern: string, scope: string, count: number): string {
   ...
   */
  private static estimateFixEffort(type: string, code: string, scope: string, count: number): 'minimal' | 'moderate' | 'significant' {
