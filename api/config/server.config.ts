...
export const ALLOWED_ORIGINS = [process.env.FRONTEND_URL, ...(process.env.COOLIFY_URL ? [process.env.COOLIFY_URL] : []), 'https://www.webability.io', 'https://hoppscotch.webability.io'];
